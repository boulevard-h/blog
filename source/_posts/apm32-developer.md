...
基础固件与之前的博客[QMK编译+Vial在线改键功能](/2022/10/24/QMK-VIAL/)基本类似，只是更改了主控有关。
...
最基础的版本参考我的博客：[QMK编译+Vial在线改键功能](/2022/10/24/QMK-VIAL/)
...
这里的代码是不支持vial的，若需要vial旋钮代码，请见博客[QMK编译+Vial在线改键功能](/2022/10/24/QMK-VIAL/)。
